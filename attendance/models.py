...
class Sector(models.Model):
    ...
    requiere_geolocalizacion = models.BooleanField(default=True)
...
class Empleado(models.Model):
    ...
    es_dueno = models.BooleanField(default=False)  # puede marcar manual sin QR
...
class SystemConfig(models.Model):
    google_sheet_id = models.CharField(max_length=100, blank=True, null=True)
